...
If your website has been around for more than three years and you have been adding content regularly without ever removing or updating anything, there is a good chance you have content that is hurting more than helping.`
  ...
  {
    id: 'chinese-new-year-marketing-mistakes',
    category: 'Chinese Market',
    title: 'The Most Common Mistakes Brands Make During Chinese New Year',
    desc: 'How to avoid performative marketing and build genuine cultural connection.',
    date: 'February 2026',
    readTime: '5 min read',
    image: 'https://images.unsplash.com/photo-1676508805939-c4050ed86c3f?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    content: `Chinese New Year, also known as Lunar New Year or Spring Festival, is the single most important shopping period for the North American Chinese community.
...
For a local business, that is an exceptionally valuable asset.`
  },
  {
    ...
    desc: 'Understanding the trust economy of the Chinese community is the key to unlocking it.',
    date: 'April 2026',
    readTime: '4 min read',
...
The trust economy is harder to enter than the attention economy. But once you are inside it, the returns compound in ways that paid advertising simply cannot replicate.`
  },
  {
    ...
    desc: 'The North American Chinese market is not one audience. It is two very different ones.',
    date: 'March 2026',
    readTime: '4 min read',
...
The brands that make this distinction deliberately will build a far more complete and durable presence in the Chinese consumer market than those who treat it as a single undifferentiated audience.`
  },
  {
    ...
    desc: 'A direct look at what goes wrong and how to fix it before you spend another dollar.',
    date: 'February 2026',
    readTime: '4 min read',
